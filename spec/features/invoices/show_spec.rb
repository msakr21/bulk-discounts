  ...
  describe 'as a merchant' do
    describe 'when I visit my merchant invoices show page (/merchants/:merchant_id/invoices/:id)' do
      before :each do
        ...
        @snorkel_invoice = InvoiceItem.create!(item_id: @snorkel.id, invoice_id: @invoice_6.id, quantity: 11, unit_price: 400, status: 1, bulk_discount_id: @discount_price_2.id)
      ...
      it 'displays a link on all of the merchant items that have had a discount applied to on the invoice' do
        visit merchant_invoice_path(@surf_designs, @invoice_6)
